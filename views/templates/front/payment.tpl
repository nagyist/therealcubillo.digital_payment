...
<h2>{l s='Resumen de la orden' mod='vposintegration'}</h2>
...
<form action="{$vpos_url}" target="_blank" class="" method="post">
  <div class="box">
    <p>
    ...
    <p>
      El total de su compra es {$currency_iso}{$total_amount}
    </p>
    ...
    <p>
       <b>{l s='Al presionar \'Confirmar mi pedido\' se abrira una nueva ventana, es necesario que ingrese los datos que se le indican.' mod='vposintegration'}</b>
    </p>
  </div>

  <p class="cart_navigation clearfix" id="cart_navigation">
    <button type="submit" class="button btn btn-default button-medium">
      <span>Confirmar mi pedido<i class="icon-chevron-right right"></i></span>
    </button>
